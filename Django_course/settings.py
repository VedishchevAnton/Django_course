...
SECRET_KEY = 'django-insecure-z5ninckfh3a9g!5-$p*2ru-p-oo7yfdyflkp1v2(a!dk1e!)di'
...
# psql --host=localhost --dbname=Django_course --username=postgres принудительных вход через сокет
...
CRONJOBS = [
    ('* * * * *', 'main.views_package.message_views.message_create_view.send_newsletter'),  # будет запускаться каждую минуту
]
